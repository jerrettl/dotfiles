...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_START_USER="${BoldWhite}$(uname -n)${ResetColor} ${Green}${PathShort}${ResetColor}"
  GIT_PROMPT_START_ROOT="${BoldWhite}$(uname -n)${ResetColor} ${Red}${PathShort}${ResetColor}"
  GIT_PROMPT_END_USER="> "
  GIT_PROMPT_END_ROOT="> "
