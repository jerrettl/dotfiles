...
pacaur -Syyu
pacaur -S --needed calc compton git i3-wm i3blocks lightdm lightdm-gtk-greeter npm ranger tmux tree vim xdotool xorg-xrdb youtube-dl zathura zathura-pdf-poppler zsh
