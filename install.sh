...
pacaur -Syyu
pacaur -S --needed calc compton git i3-wm i3blocks lightdm lightdm-gtk-greeter npm otf-san-francisco ranger rxvt-unicode tmux tree ttf-droid ttf-ms-fonts ttf-roboto vim xdotool xorg-server xorg-xrdb youtube-dl zathura zathura-pdf-poppler zsh
