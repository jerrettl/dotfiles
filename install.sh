...
pacaur -Syyu
pacaur -S --needed calc compton git i3-wm i3blocks libotf lightdm lightdm-gtk-greeter npm ranger rxvt-unicode system-san-francisco-font-git tmux tree ttf-droid ttf-ms-fonts ttf-roboto vim volumeicon xdotool xorg-server xorg-xrdb youtube-dl zathura zathura-pdf-poppler zsh
